...
res.types <- resultsNames(res)[-c(1:3)]
...
colnames(up.upset) <- colnames(down.upset) <- c("100nM A6", "1uM ISO", "1uM NE", "1uM PE", "50uM PE")
...
png(file = "results/05_upset_plot/upset_down.png",
    width = 8, 
    height = 5,
    units = "in",
    res = 400)
...
png(file = "results/05_upset_plot/upset_up.png",
    width = 8, 
    height = 5,
    units = "in",
    res = 400)
